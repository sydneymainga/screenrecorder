...
import com.Ijja.screenrecorder.utilcmnuse.rxdata.plusAssign
...
import com.Ijja.screenrecorder.uiterfacec.ScopeViewModel
...
class MainViewModel(
  ...
  fun invalidateFab() {
    ...
    if (captureEngine.isStarted()) {
      ...
      fabColorRes.value = android.R.color.holo_orange_dark
